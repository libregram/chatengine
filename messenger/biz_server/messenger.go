...
import (
	...
	"github.com/libregram/chatengine/messenger/biz_server/server/account"
	"github.com/libregram/chatengine/messenger/biz_server/server/auth"
	"github.com/libregram/chatengine/messenger/biz_server/server/bots"
	"github.com/libregram/chatengine/messenger/biz_server/server/channels"
	"github.com/libregram/chatengine/messenger/biz_server/server/contacts"
	"github.com/libregram/chatengine/messenger/biz_server/server/help"
	"github.com/libregram/chatengine/messenger/biz_server/server/langpack"
	"github.com/libregram/chatengine/messenger/biz_server/server/messages"
	"github.com/libregram/chatengine/messenger/biz_server/server/payments"
	"github.com/libregram/chatengine/messenger/biz_server/server/phone"
	"github.com/libregram/chatengine/messenger/biz_server/server/photos"
	"github.com/libregram/chatengine/messenger/biz_server/server/stickers"
	"github.com/libregram/chatengine/messenger/biz_server/server/updates"
	"github.com/libregram/chatengine/messenger/biz_server/server/users"
	...
	// "github.com/libregram/chatengine/service/bots/client"
)
