...
// TODO(@benqi): sqlmap
func (dao *DevicesDAO) Select(auth_key_id int64, user_id int32, token_type int8) *dataobject.DevicesDO {
	...
	rows, err := dao.db.Queryx(query, auth_key_id, user_id, token_type)
