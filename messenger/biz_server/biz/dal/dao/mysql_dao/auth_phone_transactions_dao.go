...
// insert into auth_phone_transactions(auth_key_id, phone_number, code, code_expired, code_msg_id, transaction_hash, sent_code_type, flash_call_pattern, next_code_type, state, api_id, api_hash, created_time) values (:auth_key_id, :phone_number, :code, :code_expired, :transaction_hash, :sent_code_type, :flash_call_pattern, :next_code_type, :state, :api_id, :api_hash, :created_time)
// TODO(@benqi): sqlmap
func (dao *AuthPhoneTransactionsDAO) Insert(do *dataobject.AuthPhoneTransactionsDO) int64 {
	var query = "insert into auth_phone_transactions(auth_key_id, phone_number, code, code_expired, code_msg_id, transaction_hash, sent_code_type, flash_call_pattern, next_code_type, state, api_id, api_hash, created_time) values (:auth_key_id, :phone_number, :code, :code_expired, :code_msg_id, :transaction_hash, :sent_code_type, :flash_call_pattern, :next_code_type, :state, :api_id, :api_hash, :created_time)"
...
// select id, code, code_expired, code_msg_id, sent_code_type, flash_call_pattern, next_code_type, attempts, state from auth_phone_transactions where auth_key_id = :auth_key_id and phone_number = :phone_number and transaction_hash = :transaction_hash
// TODO(@benqi): sqlmap
func (dao *AuthPhoneTransactionsDAO) SelectByPhoneCodeHash(auth_key_id int64, phone_number string, transaction_hash string) *dataobject.AuthPhoneTransactionsDO {
	var query = "select id, code, code_expired, code_msg_id, sent_code_type, flash_call_pattern, next_code_type, attempts, state from auth_phone_transactions where auth_key_id = ? and phone_number = ? and transaction_hash = ?"
...
//  SELECT id, code, code_expired, code_msg_id, transaction_hash， sent_code_type, flash_call_pattern, next_code_type, attempts, state FROM auth_phone_transactions WHERE auth_key_id = :auth_key_id AND phone_number = :phone_number ORDER BY id DESC LIMIT 1
// TODO(@benqi): sqlmap
func (dao *AuthPhoneTransactionsDAO) SelectLast(auth_key_id int64, phone_number string) *dataobject.AuthPhoneTransactionsDO {
	var query = "SELECT id, code, code_expired, code_msg_id, transaction_hash, sent_code_type, flash_call_pattern, next_code_type, attempts, state FROM auth_phone_transactions WHERE auth_key_id = ? AND phone_number = ? ORDER BY id DESC LIMIT 1"
	// select id, code, code_expired, code_msg_id, transaction_hash， sent_code_type, flash_call_pattern, next_code_type, attempts, state from auth_phone_transactions where auth_key_id = ? and phone_number = ? and transaction_hash = ?"
...
// TODO(@benqi): sqlmap
func (dao *AuthPhoneTransactionsDAO) UpdateCode(code, codeMsgId string, id int64) int64 {
	var query = "update auth_phone_transactions set code = ?, code_msg_id = ? where id = ?"
	r, err := dao.db.Exec(query, id)
